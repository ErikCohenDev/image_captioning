...
# Path to the images
IMAGES_PATH = "data/captions/Flicker8k_Dataset"
TEXT_PATH = "data/captions/Flickr8k_text"
...
# Load the dataset
captions_mapping, text_data = load_captions_data(f"{TEXT_PATH}/Flickr8k.token.txt")
...
# Save Model
tf.saved_model.save(caption_model, "data/model/saved_model_format")
